        ...
        <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              <div className="p-6 border-b border-gray-200 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Your latest job postings</p>
                </div>
                <button
              ...
              <div className="divide-y divide-gray-100">
                {recentJobs.length > 0 ? (
                  ...
                  <div className="p-12 text-center">
                    <HiBriefcase className="text-6xl text-gray-300 mx-auto mb-4" />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl shadow-lg p-6 text-white">
              ...
              <p className="text-blue-100 text-sm mb-6">Your hiring stats this month</p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold">
                    {stats?.totalApplications > 0
                      ? Math.round(
                          ((stats?.approved + stats?.rejected) / stats?.totalApplications) * 100
                        )
                      : 0}%
                  </span>
                </div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
              <div className="flex items-start gap-3">
                <HiLightBulb className="text-2xl text-amber-600 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Pro Tip</h4>
                  <p className="text-sm text-gray-600">
                    Jobs with detailed descriptions and clear requirements get 40% more quality applications.
                  </p>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition">
      <div className="flex items-start justify-between mb-4">
        <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${colorClasses[color]} flex items-center justify-center text-2xl text-white shadow-lg`}>
          {icon}
        </div>
